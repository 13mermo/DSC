...
import br.edu.ifnmg.psc.MercadoOfertas.Apresentacao.CadastrarPessoas;
...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItem7.setText("Pessoa Fisica");
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
         CadastrarPessoas tela;
        try {
            tela = new CadastrarPessoas();
            this.add(tela);
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        CadastrarEmpresa tela;
         try {
            tela = new CadastrarEmpresa();
            this.add(tela);
            tela.setVisible(true); 
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(Principal.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        CadastrarEscola tela;
         try {
            tela = new CadastrarEscola();
            this.add(tela);
            tela.setVisible(true); 
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(Principal.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jMenuItem7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem7ActionPerformed
            LogPessoaFisica tela;
            tela =new LogPessoaFisica();
            this.add(tela);
            tela.setVisible(true);
