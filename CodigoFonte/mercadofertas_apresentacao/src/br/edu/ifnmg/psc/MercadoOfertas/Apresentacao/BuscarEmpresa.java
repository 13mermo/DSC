 ...
 * @author Wesley
 */
public class BuscarEmpresa extends FormBuscar<Empresa> {

    EmpresaRepositorio empresa;
    public BuscarEmpresa()throws ClassNotFoundException{
        initComponents();
         setRepositorio(RepositorioBuilder.getEmpresaRepositorio());
    }
    ...
    @Override
    protected void preencherTabela(List<Empresa> dados) {
    ...
    @Override
    protected Empresa carregaFiltro() {
        Empresa filtro = new Empresa();
        if(!nome.getText().isEmpty()){
            try {
                filtro.setNome(nome.getText());
            } catch (ViolacaoRegraNegocioException ex) {
                Logger.getLogger(BuscarEmpresa.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        return filtro;
    }
    ...
    @Override
    protected Empresa novaEntidade() {
        return new Empresa();
    }
}
